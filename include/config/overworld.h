...
#define OW_ILLUMINATE               GEN_6 // Prior to Gen9, if a Pokémon with Illuminate is leading the party, the wild encounter rate is doubled.
...
#define OW_MAGNET_PULL              GEN_6 // Prior to Gen9, if a Pokémon with Magnet Pull is leading the party, there is a 50% chance to encounter a Steel-type Pokémon.
#define OW_STATIC                   GEN_6 // Prior to Gen9, if a Pokémon with Static is leading the party, there is a 50% chance to encounter an Electric-type Pokémon.
